            ...
            <div class="layui-side-scroll">
                ...
                <ul class="layui-nav layui-nav-tree" lay-filter="test">
                    ...
                    <li data-name="component" class="layui-nav-item">
                        <a href="javascript:;" lay-tips="司机信息管理" lay-direction="2">
                        ...
                        <dl class="layui-nav-child">
                            ...
                            <dd data-name="grid">
                                <a lay-href="views/show/table_driver.jsp">司机信息管理<span class="layui-nav-more"></span></a>
                            </dd>
                        </dl>
                    </li>

                    <li data-name="template" class="layui-nav-item">
                        <a href="javascript:;" lay-tips="技工信息管理" lay-direction="2">
                            <i class="layui-icon layui-icon-template"></i>
                            <cite>技工信息管理</cite>
                            <span class="layui-nav-more"></span></a>
                        <dl class="layui-nav-child">
                            <dd><a lay-href="views/show/table_tech.jsp">技工信息管理</a></dd>
                        </dl>
                    </li>

                    <li data-name="app" class="layui-nav-item">
                        <a href="javascript:;" lay-tips="车辆信息管理" lay-direction="2">
                            <i class="layui-icon layui-icon-app"></i>
                            <cite>车辆信息管理</cite>
                            <span class="layui-nav-more"></span></a>
                        <dl class="layui-nav-child">
                            <dd data-name="content">
                                <a lay-href="views/show/table_car.jsp">车辆信息管理</a>
                            </dd>
                        </dl>
                    </li>

                    <li data-name="senior" class="layui-nav-item">
                        <a href="javascript:;" lay-tips="车辆行驶历史管理" lay-direction="2">
                            <i class="layui-icon layui-icon-senior"></i>
                            <cite>车辆行驶历史管理</cite>
                            <span class="layui-nav-more"></span></a>
                        <dl class="layui-nav-child">
                            <dd data-name="echarts">
                                <a lay-href="views/show/table_carinfo.jsp">车辆行驶历史管理<span class="layui-nav-more"></span></a>
                            </dd>
                        </dl>
                    </li>
                    ...
                    <li data-name="user" class="layui-nav-item">
                        ...
                        <dl class="layui-nav-child">
                            <dd>
                                <a lay-href="views/show/table_admin.jsp">用户管理</a>
                            </dd>
                        </dl>
                    </li>
                </ul>
