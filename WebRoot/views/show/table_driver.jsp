	      ...
	      <form method="post" action="${pageContext.request.contextPath}/driver_delete">
		      ...
		      <div class="modal-dialog">
		        <div class="modal-content">
	              ...
	              <div class="form-horizontal">
	              	  <div class="form-group">
		                <label for="delete_did" class="col-sm-2 control-label">司机序号:*</label>
		                <div class="col-sm-10">
		                  <input class="form-control" name="driver.did" id="delete_did" type="text">
		                </div>
		              </div>
	              	  <div class="form-group">
		                <label for="delete_dname" class="col-sm-2 control-label">姓名:*</label>
		                <div class="col-sm-10">
		                  <input class="form-control" name="driver.dname" id="delete_dname" type="text">
		                </div>
		              </div>
		              <div class="form-group">
		                <label for="delete_dphone" class="col-sm-2 control-label">手机号:*</label>
		                <div class="col-sm-10">
		                  <input class="form-control" name="driver.dphone" id="delete_dphone" type="text">
		                </div>
		              </div>
		              <div class="form-group">
		                <label for="delete_dpassword" class="col-sm-2 control-label">登录密码:*</label>
		                <div class="col-sm-10">
		                  <input class="form-control" name="driver.dpassword" id="delete_dpassword" type="text">
		                </div>
		              </div>
		              <div class="form-group">
		                <label for="delete_dworkyear" class="col-sm-2 control-label">工作年限:*</label>
		                <div class="col-sm-10">
		                  <input class="form-control" name="driver.dworkyear" id="delete_dworkyear" type="text">
		                </div>
		              </div>
		              <div class="form-group">
		                <label for="delete_dsex" class="col-sm-2 control-label">性别:*</label>
		                <div class="col-sm-10">
		                  <input class="form-control" name="driver.dsex" id="delete_dsex" type="text">
		                </div>
		              </div>
		              <div class="form-group">
		                <label for="delete_dage" class="col-sm-2 control-label">年龄:*</label>
		                <div class="col-sm-10">
		                  <input class="form-control" name="driver.dage" id="delete_dage" type="text">
		                </div>
		              </div>
	              </div>
	            </div>
