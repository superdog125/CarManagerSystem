	          ...
	          <div class="modal-content">
	            ...
	            <div id="editTecherModal" class="modal-body">
	              <div class="form-horizontal">
	                ...
	                <div class="col-sm-10">
	                  <input class="form-control" name="techer.tid" id="edit_tid" type="text">
	                </div>
	              </div>
              	  <div class="form-group">
		      ...
		      <div class="modal-dialog">
		        <div class="modal-content">
	              ...
	              <div class="form-horizontal">
		                ...
		                <div class="col-sm-10">
		                  <input class="form-control" name="techer.tid" id="delete_tid" type="text">
		                </div>
		              </div>
	                  <div class="form-group">
		                <label for="delete_tname" class="col-sm-2 control-label">姓名:*</label>
		                <div class="col-sm-10">
		                  <input class="form-control" name="techer.tname" id="delete_tname" type="text">
		                </div>
		              </div>
		              <div class="form-group">
		                <label for="delete_tphone" class="col-sm-2 control-label">手机号:*</label>
		                <div class="col-sm-10">
		                  <input class="form-control" name="techer.tphone" id="delete_tphone" type="text">
		                </div>
		              </div>
		              <div class="form-group">
		                <label for="delete_tpassword" class="col-sm-2 control-label">登录密码:*</label>
		                <div class="col-sm-10">
		                  <input class="form-control" name="techer.tpassword" id="delete_tpassword" type="text">
		                </div>
		              </div>
		              <div class="form-group">
		                <label for="delete_tworkyear" class="col-sm-2 control-label">入职时间:*</label>
		                <div class="col-sm-10">
		                  <input class="form-control" name="techer.tworkyear" id="delete_tworkyear" type="text">
		                </div>
		              </div>
		              <div class="form-group">
		                <label for="delete_tsex" class="col-sm-2 control-label">性别:*</label>
		                <div class="col-sm-10">
		                  <input class="form-control" name="techer.tsex" id="delete_tsex" type="text">
		                </div>
		              </div>
		              <div class="form-group">
		                <label for="delete_tage" class="col-sm-2 control-label">年龄:*</label>
		                <div class="col-sm-10">
		                  <input class="form-control" name="techer.tage" id="delete_tage" type="text">
		                </div>
		              </div>
		            </div>
			          </div>
