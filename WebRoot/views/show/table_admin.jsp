	            ...
	            <div id="editUserModal" class="modal-body">
	              <div class="form-horizontal">
	              		<div class="form-group">
			                ...
			                <div class="col-sm-10">
			                  <input class="form-control" name="user.uid" id="edit_aid" type="text">
			                </div>
			             </div>
	              	  	<div class="form-group">
		      ...
		      <div class="modal-dialog">
		        <div class="modal-content">
	              ...
	              <div class="form-horizontal">
		                ...
		                <div class="col-sm-10">
		                  <input class="form-control" name="user.uid" id="delete_aid" type="text">
		                </div>
		              </div>
	                  <div class="form-group">
		                <label for="delete_aname" class="col-sm-2 control-label">登录账号:*</label>
		                <div class="col-sm-10">
		                  <input class="form-control" name="user.loginName" id="delete_aname" type="text">
		                </div>
		              </div>
		              <div class="form-group">
		                <label for="delete_atname" class="col-sm-2 control-label">姓名:*</label>
		                <div class="col-sm-10">
		                  <input class="form-control" name="user.userName" id="delete_atname" type="text">
		                </div>
		              </div>
		              <div class="form-group">
		                <label for="delete_apassword" class="col-sm-2 control-label">密码:*</label>
		                <div class="col-sm-10">
		                  <input class="form-control" name="user.loginPwd" id="delete_apassword" type="text">
		                </div>
		              </div>
		              <div class="form-group">
		                <label for="delete_aphone" class="col-sm-2 control-label">手机号:*</label>
		                <div class="col-sm-10">
		                  <input class="form-control" name="user.telephone" id="delete_aphone" type="text">
		                </div>
		              </div>
	              </div>
	            </div>
