	          ...
	          <div class="modal-content">
	            ...
	            <div id="editCarModal" class="modal-body">
	              <div class="form-horizontal">
		                ...
		                <div class="col-sm-10">
		                  <input class="form-control" name="car.cid" id="edit_cid" type="text">
		                </div>
		              </div>
	                  <div class="form-group">
		      ...
		      <div class="modal-dialog">
		        <div class="modal-content">
	              ...
	              <div class="form-horizontal">
		                ...
		                <div class="col-sm-10">
		                  <input class="form-control" name="car.cid" id="delete_cid" type="text">
		                </div>
		              </div>
	                  <div class="form-group">
		                <label for="delete_cbrand" class="col-sm-2 control-label">品牌:*</label>
		                <div class="col-sm-10">
		                  <input class="form-control" name="car.cbrand" id="delete_cbrand" type="text">
		                </div>
		              </div>
		              <div class="form-group">
		                <label for="delete_cnumber" class="col-sm-2 control-label">车牌号:*</label>
		                <div class="col-sm-10">
		                  <input class="form-control" name="car.cnumber" id="delete_cnumber" type="text">
		                </div>
		              </div>
		              <div class="form-group">
		                <label for="delete_cfix" class="col-sm-2 control-label">维修情况:*</label>
		                <div class="col-sm-10">
		                  <input class="form-control" name="car.cfix" id="delete_cfix" type="text">
		                </div>
		              </div>
		              <div class="form-group">
		                <label for="delete_cproblem" class="col-sm-2 control-label">故障信息:*</label>
		                <div class="col-sm-10">
		                  <input class="form-control" name="car.cproblem" id="delete_cproblem" type="text">
		                </div>
		              </div>
		              <div class="form-group">
		                <label for="delete_ccheck" class="col-sm-2 control-label">年检信息:*</label>
		                <div class="col-sm-10">
		                  <input class="form-control" name="car.ccheck" id="delete_ccheck" type="text">
		                </div>
		              </div>
	              </div>
	            </div>
