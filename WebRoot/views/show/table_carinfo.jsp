			        ...
			        <div class="modal-content">
			          ...
			          <div id="addCarInfoModal" class="modal-body">
			            ...
			            <div class="form-group">
			                <label for="add_ciid" class="col-sm-2 control-label">序号:*</label>
			                <div class="col-sm-10">
			                  <input class="form-control" name="carinfo.ciid" id="add_ciid" type="text">
			                </div>
			              </div>
			              <div class="form-group">
			                <label for="add_cnumber" class="col-sm-2 control-label">车牌号:*</label>
			                <div class="col-sm-10">
			                  <input class="form-control" name="carinfo.car.cnumber" id="add_cnumber" type="text">
			                </div>
			              </div>
			              <div class="form-group">
			                <label for="add_did" class="col-sm-2 control-label">驾驶员编号:*</label>
			                <div class="col-sm-10">
			                  <input class="form-control" name="carinfo.driver.did" id="add_did" type="text">
			                </div>
			              </div>
			              <div class="form-group">
			                <label for="add_cistart" class="col-sm-2 control-label">起点:*</label>
			                <div class="col-sm-10">
			                  <input class="form-control" name="carinfo.cistart" id="add_cistart" type="text">
			                </div>
			              </div>
			              <div class="form-group">
			                <label for="add_ciend" class="col-sm-2 control-label">终点:*</label>
			                <div class="col-sm-10">
			                  <input class="form-control" name="carinfo.ciend" id="add_ciend" type="text">
			                </div>
			              </div>
			              <div class="form-group">
			                <label for="add_cicost" class="col-sm-2 control-label">花费:*</label>
			                <div class="col-sm-10">
			                  <input class="form-control" name="carinfo.cicost" id="add_cicost" type="text">
			                </div>
			              </div>
			              <div class="form-group">
			                <label for="add_cioil" class="col-sm-2 control-label">油耗:*</label>
			                <div class="col-sm-10">
			                  <input class="form-control" name="carinfo.cioil" id="add_cioil" type="text">
			                </div>
			              </div>
			              <div class="form-group">
			                <label for="add_citime" class="col-sm-2 control-label">行驶时间:*</label>
			                <div class="col-sm-10">
			                  <input class="form-control" name="carinfo.citime" id="add_citime" type="text">
			                </div>
			              </div>
			            </div>
			          </div>
	          ...
	          <div class="modal-content">
	            ...
	            <div id="editCarInfoModal" class="modal-body">
	              <div class="form-horizontal">
		                ...
		                <div class="col-sm-10">
		                  <input class="form-control" name="carinfo.ciid" id="edit_ciid" type="text">
		                </div>
		              </div>
	              	  <div class="form-group">
		                <label for="edit_cnumber" class="col-sm-2 control-label">车辆序号:*</label>
		                <div class="col-sm-10">
		                  <input class="form-control" name="carinfo.car.cnumber" id="edit_cnumber" type="text">
		                </div>
		              </div>
		              <div class="form-group">
		                <label for="edit_did" class="col-sm-2 control-label">驾驶员编号:*</label>
		                <div class="col-sm-10">
		                  <input class="form-control" name="carinfo.driver.did" id="edit_did" type="text">
		                </div>
		              </div>
		              <div class="form-group">
		                <label for="edit_cistart" class="col-sm-2 control-label">起点:*</label>
		                <div class="col-sm-10">
		                  <input class="form-control" name="carinfo.cistart" id="edit_cistart" type="text">
		                </div>
		              </div>
		              <div class="form-group">
		                <label for="edit_ciend" class="col-sm-2 control-label">终点:*</label>
		                <div class="col-sm-10">
		                  <input class="form-control" name="carinfo.ciend" id="edit_ciend" type="text">
		                </div>
		              </div>
		              <div class="form-group">
		                <label for="edit_cicost" class="col-sm-2 control-label">花费:*</label>
		                <div class="col-sm-10">
		                  <input class="form-control" name="carinfo.cicost" id="edit_cicost" type="text">
		                </div>
		              </div>
		              <div class="form-group">
		                <label for="edit_cioil" class="col-sm-2 control-label">油耗:*</label>
		                <div class="col-sm-10">
		                  <input class="form-control" name="carinfo.cioil" id="edit_cioil" type="text">
		                </div>
		              </div>
		              <div class="form-group">
		                <label for="edit_citime" class="col-sm-2 control-label">行驶时间:*</label>
		                <div class="col-sm-10">
		                  <input class="form-control" name="carinfo.citime" id="edit_citime" type="text">
		                </div>
		              </div>
	              </div>
	            </div>
		      ...
		      <div class="modal-dialog">
		        <div class="modal-content">
	              ...
	              <div class="form-horizontal">
		                ...
		                <div class="col-sm-10">
		                  <input class="form-control" name="carinfo.ciid" id="delete_ciid" type="text">
		                </div>
		              </div>
	              	  <div class="form-group">
		                <label for="delete_cnumber" class="col-sm-2 control-label">车牌号:*</label>
		                <div class="col-sm-10">
		                  <input class="form-control" name="carinfo.car.cid" id="delete_cnumber" type="text">
		                </div>
		              </div>
		              <div class="form-group">
		                <label for="delete_did" class="col-sm-2 control-label">驾驶员编号:*</label>
		                <div class="col-sm-10">
		                  <input class="form-control" name="carinfo.driver.did" id="delete_did" type="text">
		                </div>
		              </div>
		              <div class="form-group">
		                <label for="delete_cistart" class="col-sm-2 control-label">起点:*</label>
		                <div class="col-sm-10">
		                  <input class="form-control" name="carinfo.cistart" id="delete_cistart" type="text">
		                </div>
		              </div>
		              <div class="form-group">
		                <label for="delete_ciend" class="col-sm-2 control-label">终点:*</label>
		                <div class="col-sm-10">
		                  <input class="form-control" name="carinfo.ciend" id="delete_ciend" type="text">
		                </div>
		              </div>
		              <div class="form-group">
		                <label for="delete_cicost" class="col-sm-2 control-label">花费:*</label>
		                <div class="col-sm-10">
		                  <input class="form-control" name="carinfo.cicost" id="delete_cicost" type="text">
		                </div>
		              </div>
		              <div class="form-group">
		                <label for="delete_cioil" class="col-sm-2 control-label">油耗:*</label>
		                <div class="col-sm-10">
		                  <input class="form-control" name="carinfo.cioil" id="delete_cioil" type="text">
		                </div>
		              </div>
		              <div class="form-group">
		                <label for="delete_citime" class="col-sm-2 control-label">行驶时间:*</label>
		                <div class="col-sm-10">
		                  <input class="form-control" name="carinfo.citime" id="delete_citime" type="text">
		                </div>
		              </div>
	              </div>
	            </div>
